<div class="wpgmza-map">
	...
	<div class="error is-hidden" id="wpgmza-jquery-error" data-wpgmza-wp-filter-prepend="wpgmza_map_jquery_error_prepend" data-wpgmza-wp-filter-append="wpgmza_map_jquery_error_append" data-wpgmza-wp-filter="wpgmza_map_jquery_error_filter">
		<?php
	...
	<div class="wpgmza-load-failed update-nag is-hidden" style="text-align:center;" data-wpgmza-wp-filter-prepend="wpgmza_map_map_load_error_prepend" data-wpgmza-wp-filter-append="wpgmza_map_map_load_error_append" data-wpgmza-wp-filter="wpgmza_map_map_load_error_filter">
		<small>
			<strong>
